...
//Fill option region and distric
...
for (var key in array) {
    districArray.push(array[key].districts);
}
...
$("#region").change(function () {
    ...
    $("#district").empty();
    $("#district").append($("<option></option>").text('Chọn Quận/Huyện'));
    // if (county === -1) {
    //     $("#distric").append($("<option></option>").text('Chọn Quận/Huyện'));
    // } else {
        for (var key in districArray[county]) {
            array.push(districArray[county][key]);
        }
        for (var i = 0; i < array.length; i++) {
            $("#district").append($("<option></option>").text(array[i]));
        }
        $("#district").attr("disabled", false);
    //}
});

//Check validate form information
$(document).ready(function() {
    $('#email-order').keyup(function () {
    ...
    $('#region').change(function () {
        if ($(this).val() !== 'Chọn Tỉnh/Thành phố') {
            $(this).removeClass('is-invalid');
            $(this).addClass('is-valid');
    ...
    $('#btn-submit-information').click(function() {
        if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test($('#email-order').val())) {
            $('#email-order').removeClass('is-invalid');
            $('#email-order').addClass('is-valid');
        } else {
            $('#email-order').removeClass('is-valid');
            $('#email-order').addClass('is-invalid');
        }
        if ($('#name-order').val() !== '') {
            $('#name-order').removeClass('is-invalid');
            $('#name-order').addClass('is-valid');
        } else {
            $('#name-order').removeClass('is-valid');
            $('#name-order').addClass('is-invalid');
        }
        if (/^\d{10,11}$/.test($('#phone').val())) {
        ...
        if ($('#region').val() !== 'Chọn Tỉnh/Thành phố') {
        ...
        if ($('#district').val() !== 'Chọn Quận/Huyện') {
            $('#district').removeClass('is-invalid');
        ...
        if($('#email').hasClass('is-invalid') || $('#name').hasClass('is-invalid') || $('#phone').hasClass('is-invalid') || $('#region').hasClass('is-invalid') || $('#district').hasClass('is-invalid') || $('#address').hasClass('is-invalid')) {
            return false;
        } else {
            return true;
        }
